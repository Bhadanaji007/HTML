...
function start() {
  ...
  setTimeout(() => {
    msgBox.style.display = "block";
    msgBox.innerHTML = "TU THODA B.K.L HAI ?";
    msgBox.style.left = "650px";
    setTimeout(() => {
      msgBox.style.display = "block";
      msgBox.innerHTML = "VASU BHAI AAB DARD BARDASH NAHI <br> HOTA ♥";
      msgBox.style.left = "50px";
      setTimeout(() => {
        msgBox.style.display = "block";
        msgBox.innerHTML =
          " ARYAN TU SAHI MA B.K.L HAI <br> TU APNA CDS PA DHYAN DA ";
        msgBox.style.left = "650px";
        setTimeout(() => {
          msgBox.style.display = "block";
          msgBox.innerHTML =
            "USNA JO DARD DIYA VO AAB TU DESH KA DUSMANO KO DA ♥";
          msgBox.style.left = "650px";
          setTimeout(() => {
            msgBox.style.display = "none";
          }, 8000);
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          codingBox.style.display = "block";
          codingBox.innerHTML = 'CDS WRITTEN PREP STARTED';
          setTimeout(() => {
            codingBox.style.display = "none";
            setTimeout(() => {
              codingBox.style.display = "block";
              codingBox.innerHTML = 'NCERT REVISION STARTED(AAB DIL NAHI LAGUNGA)';
              setTimeout(() => {
                codingBox.style.display = "none";
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      codingBox.innerHTML = "LOW TEST SCORE";
      setTimeout(() => {
        codingBox.style.display = "none";
        setTimeout(() => {
          codingBox.style.display = "block";

          codingBox.innerHTML = 'ZERO PERSONALITY DEVLOPMENT';
          setTimeout(() => {
            codingBox.style.display = "none";
            setTimeout(() => {
              codingBox.style.display = "block";
              codingBox.innerHTML = "SELF - DOUBT !";
              setTimeout(() => {
                codingBox.style.display = "none";
                setTimeout(() => {
                  stickman.style.display = "none";
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      msgBox.style.display = "block";
      msgBox.innerHTML = "AAB KYA HO GYA ?";
      msgBox.style.left = "650px";
      setTimeout(() => {
        msgBox.innerHTML = "  <br>BHAI CHASMA WALI PARI SA DISTRACT HOGAYA THA !";
        msgBox.style.left = "50px";
        setTimeout(() => {
          msgBox.innerHTML = "DO revision <br> prepare for SSB ";
          msgBox.style.left = "650px";
          setTimeout(() => {
            msgBox.innerHTML = "NEWSPAPER WILL ALSO HELP YOU";
            msgBox.style.left = "650px";
            setTimeout(() => {
              msgBox.style.display = "none";
              setTimeout(() => {
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      codingBox.innerHTML = "CLEARED WRITTEN !";
      setTimeout(() => {
        codingBox.style.display = "none";
        setTimeout(() => {
          codingBox.style.display = "block";
          codingBox.innerHTML = "CLEARED SSB !";
          setTimeout(() => {
            codingBox.style.display = "none";
            setTimeout(() => {
              stickman.style.display = "none";
  ...
  setTimeout(() => {
    ...
    msgBox.innerHTML = "Created By <br> ARYAN BHADANA DEDUPURWALA";
  }, 209000);
}
